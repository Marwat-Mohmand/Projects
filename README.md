...
- **Database:** 
- **DevOps & Tools:** Git, Netlify  

### **🚀 Latest Projects**  
- [Project 1](https://github.com/Marwat-Mohmand) – Short description
- pay attention eaach project has it own name for example the first project is Clock.
